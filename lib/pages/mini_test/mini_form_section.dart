...
import 'package:toefl/pages/mini_test/mini_multiple_choices.dart';
...
class MiniFormSection extends ConsumerStatefulWidget {
  const MiniFormSection({super.key, required this.questions});

  final List<Question> questions;

  @override
  ConsumerState<MiniFormSection> createState() => _FormSectionState();
}

class _FormSectionState extends ConsumerState<MiniFormSection> {
    ...
    return [
      ...
      Consumer(builder: (context, ref, child) {
        ...
        if (state.selectedQuestions.isEmpty) {
          ...
          return MiniMultipleChoices(question: question);
        }
      }),
    ];
  }
